...
public class DistanceMetricTest
{
    ...
    /**
     * Test metric - if shortest path is chosen.
     * 
     ...
     */
    @Test public void testMetric() throws NoPathAvailableException, NotEnoughSpaceLeftException, FsObjectNotFoundException, NotMountedException
    {
        MetricDfsPathPicker builder = new MetricDfsPathPicker(
                new DijkstraGraphSearcher(new DistanceMetric()));
        ...
        assertEquals(bw2.bpsProperty().get(), result.getCurrentPossibleThroughput(0).bpsProperty().get());
    }
